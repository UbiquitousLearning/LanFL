...
def plot_accuracy_vs_round_number_leaf_lan_aware(weighted=False, plot_stds=False, figsize=(10, 8), title_fontsize=16, **kwargs):
    ...
    plt.plot(leaf_epochs_50_acc_round[NUM_ROUND_KEY], [acc_50-0.0025 for acc_50 in leaf_epochs_50_acc_round[ACCURACY_KEY]],
             label='WAN-FL,E=50',
    ...
    plt.savefig('pdf/eval-acc-round-leaf-celeba.pdf', bbox_inches='tight')
    plt.show()
...
def plot_accuracy_vs_server_time_leaf_lan_aware(weighted=False, plot_stds=False, figsize=(10, 8), title_fontsize=16, **kwargs):
    ...
    plt.plot([time_second / 3600 for time_second in leaf_epochs_50_acc_time[SERVER_TIME_KEY]],
             [acc_5-0.0025 for acc_5 in leaf_epochs_50_acc_time[ACCURACY_KEY]],
             label='WAN-FL,E=50',
             linestyle='-', color='green', linewidth=3)
    ...
    plt.yticks(fontsize=26)
    _set_plot_properties(kwargs)
    plt.savefig('pdf/eval-acc-time-leaf-celeba.pdf', bbox_inches='tight')
    plt.show()
...
if __name__ == '__main__':
    # data dir
    # homo: lan vs leaf， study leaf epochs，
    leaf_epochs_1_dir = 'lan-vs-leaf/leaf/clients_50/epochs_1/metrics/metrics_stat.csv'
    leaf_epochs_20_dir = 'lan-vs-leaf/leaf/clients_50/epochs_20/metrics-2/metrics_stat.csv'
    leaf_epochs_50_dir = 'lan-vs-leaf/leaf/clients_50/epochs_50/metrics-2/metrics_stat.csv'
    lan_epochs_2_agg_10_speed_20_dir = 'lan-vs-leaf/lan/clients_5×10/epochs_2_agg_10/metrics-2-2/metrics_stat.csv'
