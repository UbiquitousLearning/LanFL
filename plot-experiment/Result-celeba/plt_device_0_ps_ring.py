...
def plot_accuracy_vs_round_number_leaf_lan_aware(weighted=False, plot_stds=False, figsize=(10, 8), title_fontsize=16, **kwargs):
    ...
    plt.plot([time_second / 3600 for time_second in lan_ring_1_acc_time[SERVER_TIME_KEY]],
             lan_ring_1_acc_time[ACCURACY_KEY],
             label='LanFL(Ring-1),BL=20',
             linestyle='--', color='orange', linewidth=3)
    plt.plot([time_second / 3600 for time_second in lan_ring_4_acc_time[SERVER_TIME_KEY]],
             lan_ring_4_acc_time[ACCURACY_KEY],
             label='LanFL(Ring-4),BL=62',
             linestyle='--', color='green', linewidth=3)
    plt.plot([time_second / 3600 for time_second in lan_ps_1_acc_time[SERVER_TIME_KEY]],
             lan_ps_1_acc_time[ACCURACY_KEY],
             label='LanFL(PS-1),BL=22',
             linestyle='-.', color='blue', linewidth=3)
    plt.plot([time_second / 3600 for time_second in lan_ps_4_acc_time[SERVER_TIME_KEY]],
             lan_ps_4_acc_time[ACCURACY_KEY],
...
if __name__ == '__main__':
    ...
    lan_ps_1_dir = 'ps-ring/lan/clients_5×8/epochs_2_agg_10/ps-1/metrics-2/metrics_stat.csv'
    lan_ps_4_dir = 'ps-ring/lan/clients_5×8/epochs_2_agg_10/ps-4/metrics-2/metrics_stat.csv'
    lan_ring_1_dir = 'ps-ring/lan/clients_5×8/epochs_2_agg_10/ring-1/metrics-2/metrics_stat.csv'
    lan_ring_4_dir = 'ps-ring/lan/clients_5×8/epochs_2_agg_10/ring-4/metrics-2/metrics_stat.csv'
