...
def plot_accuracy_vs_round_number(weighted=False, figsize=(10, 8), title_fontsize=16, **kwargs):
...
def plot_accuracy_vs_server_time(weighted=False, figsize=(10, 8), **kwargs):
    plt.figure(figsize=figsize)
    ...
    plt.savefig('pdf/eval-heter-celeba-setting2.pdf', bbox_inches='tight')
    plt.show()
...
if __name__ == '__main__':
    ...
    speed_2020202020_dir = 'lan-vs-leaf/lan/clients_5×10/epochs_2_agg_10/metrics-2/metrics_stat.csv'
    # heter-1: lan bandwidth = [10, 10, 10, 10, 30]
    # speed_1010101030_dir = 'heter_speed/clients_5×10/epochs_2_agg_10/speed_1010101030/metrics/metrics_stat.csv'
    # speed_2020202020_op_dir = 'heter_speed/clients_5×10/epochs_2_agg_10/speed_2020202020_op/metrics/metrics_stat.csv'
    # heter-2: lan bandwidth = [5, 20, 20, 40, 40]
    speed_1010101030_dir = 'heter_speed/clients_5×10/epochs_2_agg_10/speed_520204040/metrics/metrics_stat.csv'
    speed_2020202020_op_dir = 'heter_speed/clients_5×10/epochs_2_agg_10/speed_520204040_op/metrics/metrics_stat.csv'
    ...
    # plot_accuracy_vs_round_number(weighted=True)
    plot_accuracy_vs_server_time(weighted=True)
    print()
