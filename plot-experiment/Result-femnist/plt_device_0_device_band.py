...
if __name__ == '__main__':
    # data dir
    # 同构lan vs leaf， 固定lan的个数=5， 比较leaf-2,lan-10,20,30
    # leaf_epochs_20_dir = 'ps-ring/leaf/clients_40/epochs_20/metrics-2/metrics_stat.csv'
    lan_device_2_dir = 'tunNC/clients_5×2/ps/metrics/metrics_stat.csv'
    lan_device_5_dir = 'tunNC/clients_5×5/ps/metrics/metrics_stat.csv'
    lan_device_10_dir = 'tunNC/clients_5×10/ps/metrics/metrics_stat.csv'
    lan_device_20_bl_2_dir = 'tunNC/clients_5×20/ps/metrics-1/metrics_stat.csv'
    lan_device_20_bl_5_dir = 'tunNC/clients_5×20/ps/metrics-2/metrics_stat.csv'
