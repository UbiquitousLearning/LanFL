...
def plot_accuracy_vs_round_number_leaf_lan_aware(weighted=False, plot_stds=False, figsize=(10, 8), title_fontsize=16, **kwargs):
    ...
    plt.title('Weighted Accuracy vs Round Number (%s)', fontsize=title_fontsize)
    ...
    plt.plot(leaf_epochs_20_acc_round[NUM_ROUND_KEY], leaf_epochs_20_acc_round[ACCURACY_KEY],
             ...
             linestyle='-', color='red', linewidth=3)
    plt.plot(lan_epochs_2_agg_10_speed_20_acc_round[NUM_ROUND_KEY], lan_epochs_2_agg_10_speed_20_acc_round[ACCURACY_KEY],
             label='Lan,E=2,A=5,LB=20',
             linestyle=':', color='blue', linewidth=3)
    plt.plot(lan_epochs_2_agg_10_speed_10_acc_round[NUM_ROUND_KEY],
             lan_epochs_2_agg_10_speed_10_acc_round[ACCURACY_KEY],
             label='Lan,E=2,A=5,LB=10',
             linestyle='--', color='green', linewidth=3)
    plt.plot(lan_epochs_2_agg_10_speed_30_acc_round[NUM_ROUND_KEY],
             lan_epochs_2_agg_10_speed_30_acc_round[ACCURACY_KEY],
             label='Lan,E=2,A=5,LB=30',
             linestyle='-.', color='purple', linewidth=3)
...
def plot_accuracy_vs_server_time_leaf_lan_aware(weighted=False, plot_stds=False, figsize=(10, 8), title_fontsize=16, **kwargs):
    ...
    _set_plot_properties(kwargs)
    plt.savefig('pdf/eval-time-speed-femnist.pdf', bbox_inches='tight')
    plt.show()
...
if __name__ == '__main__':
    ...
    lan_epochs_2_agg_10_speed_20_dir = 'lan-vs-leaf/lan/clients_5×10/device_2/epochs_2_agg_5/metrics-2/metrics_stat.csv'
    lan_epochs_2_agg_10_speed_10_dir = 'lan-vs-leaf/lan/clients_5×10/device_2/epochs_2_agg_5/metrics-1/metrics_stat.csv'
    lan_epochs_2_agg_10_speed_30_dir = 'lan-vs-leaf/lan/clients_5×10/device_2/epochs_2_agg_5/metrics-3/metrics_stat.csv'
    ...
    lan_epochs_2_agg_10_speed_20_acc_round = get_acc(load_data(lan_epochs_2_agg_10_speed_20_dir), NUM_ROUND_KEY,
                                                     weighted=True)
    lan_epochs_2_agg_10_speed_20_acc_time = get_acc(load_data(lan_epochs_2_agg_10_speed_20_dir), SERVER_TIME_KEY,
                                                    weighted=True)
    lan_epochs_2_agg_10_speed_10_acc_round = get_acc(load_data(lan_epochs_2_agg_10_speed_10_dir), NUM_ROUND_KEY,
                                                     weighted=True)
    lan_epochs_2_agg_10_speed_10_acc_time = get_acc(load_data(lan_epochs_2_agg_10_speed_10_dir), SERVER_TIME_KEY,
                                                    weighted=True)
    lan_epochs_2_agg_10_speed_30_acc_round = get_acc(load_data(lan_epochs_2_agg_10_speed_30_dir), NUM_ROUND_KEY,
                                                     weighted=True)
    lan_epochs_2_agg_10_speed_30_acc_time = get_acc(load_data(lan_epochs_2_agg_10_speed_30_dir), SERVER_TIME_KEY,
                                                    weighted=True)

    # num
    # leaf_epochs_10_dir = 'lan-vs-leaf/leaf/clients_50/device_2/epochs_10/metrics-2/metrics_stat.csv'
    # lan_epochs_2_agg_10_lan_5_dir = 'lan-vs-leaf/lan/clients_5×10/epochs_2_agg_5/metrics-2/metrics_stat.csv'
    # lan_epochs_2_agg_10_lan_1_dir = 'lan-vs-leaf/lan/clients_1×10/epochs_2_agg_5/metrics/metrics_stat.csv'
    # lan_epochs_2_agg_10_lan_2_dir = 'lan-vs-leaf/lan/clients_2×10/epochs_2_agg_5/metrics/metrics_stat.csv'
    # lan_epochs_2_agg_10_lan_10_dir = 'lan-vs-leaf/lan/clients_10×10/epochs_2_agg_5/metrics/metrics_stat.csv'
    #
    # leaf_epochs_10_acc_round = get_acc(load_data(leaf_epochs_10_dir), NUM_ROUND_KEY, weighted=True)
    # leaf_epochs_10_acc_time = get_acc(load_data(leaf_epochs_10_dir), SERVER_TIME_KEY, weighted=True)
    # lan_epochs_2_agg_10_lan_5_acc_round = get_acc(load_data(lan_epochs_2_agg_10_lan_5_dir), NUM_ROUND_KEY,
    #                                               weighted=True)
    # lan_epochs_2_agg_10_lan_5_acc_time = get_acc(load_data(lan_epochs_2_agg_10_lan_5_dir), SERVER_TIME_KEY,
    #                                              weighted=True)
    # lan_epochs_2_agg_10_lan_1_acc_round = get_acc(load_data(lan_epochs_2_agg_10_lan_1_dir), NUM_ROUND_KEY,
    #                                               weighted=True)
    # lan_epochs_2_agg_10_lan_1_acc_time = get_acc(load_data(lan_epochs_2_agg_10_lan_1_dir), SERVER_TIME_KEY,
    #                                              weighted=True)
    # lan_epochs_2_agg_10_lan_2_acc_round = get_acc(load_data(lan_epochs_2_agg_10_lan_2_dir), NUM_ROUND_KEY,
    #                                               weighted=True)
    # lan_epochs_2_agg_10_lan_2_acc_time = get_acc(load_data(lan_epochs_2_agg_10_lan_2_dir), SERVER_TIME_KEY,
    #                                              weighted=True)
